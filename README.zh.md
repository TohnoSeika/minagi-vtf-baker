...
▶️ [在 Bilibili 观看](https://www.bilibili.com/video/BV1Hv7564ERA)（完全中文——界面、语音、字幕均为中文）
...
> 💡 当前版本 **v1.0.1**，安装包约 6MB。另有绿色便携版（无需安装，解压即用）。
...
### v1.0.1
- 🎉 v1.0.1 版本发布
- 🖼️ 修复软件界面文本显示可能存在的误导性
- 🔧 精简了输出格式下拉菜单的选项文字（DXT1 / DXT5 / RGBA8888）
